...
SECRET_KEY = 'django-insecure-e0_62#9^766dbyhp96!55vn$fgn&k7!+(1ow#x%+7siuea9b)n'
...
ASGI_APPLICATION = "club_event_management.routing.application"
...
# Allow React front end communication with django
...
# to use authentication function
